...
const webServices = [
  ...
  },
  {
    ...
    description: 'Dedykowane systemy CRM, portale klienta i panele B2B - z automatyzacjami AI, które przejmują żmudną pracę. Szyte na miarę, skalowalne bez ograniczeń.',
    icon: Globe,
