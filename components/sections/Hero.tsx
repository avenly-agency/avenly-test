...
// Warianty tylko dla desktopu (bez zmian)
...
export const Hero = () => {
  // Domyślnie false, aby uniknąć Hydration Mismatch, ale efekty ciężkie włączamy po sprawdzeniu
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
        {/* MOBILE: Lżejsze tło statyczne (bez ciężkiego blura CSS) */}
        <div className="md:hidden absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(37,99,235,0.1),transparent_70%)]"></div>

        {/* DESKTOP: Pełne efekty animowane */}
        {isDesktop && (
            <>
                <motion.div 
      ...
      <div className="w-full max-w-[1800px] px-6 md:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
        ...
        <div className="flex-1 text-center lg:text-left space-y-10 relative z-20">
          ...
          {/* Badge: Animujemy tylko na desktopie, na mobile statyczny */}
          <motion.div 
          ...
          {/* H1: CRITICAL LCP ELEMENT - Na mobile bez initial opacity: 0 */}
          <motion.h1 
            initial={isDesktop ? { opacity: 0, y: 15 } : {}}
            animate={isDesktop ? { opacity: 1, y: 0 } : {}}
        ...
        {/* PRAWA STRONA: MODAL (Tylko desktop) */}
        {/* hidden lg:block - ukrywamy cały ciężki DOM na mobile, to ogromny boost dla TBT */}
